                                ...
                                <div className="main-product-details">
                                    ...
                                    <div className="py-3 border-bottom">
                                        <h5 className="price mb-3 d-flex align-items-center gap-3">
                                            <div className="red-price text-danger fw-bold ">₹38000</div>
                                            <strike className="fs-xsm text-muted">₹50000</strike>
                                        </h5>
                        ...
                        <div className="col-12">
                            <div className="bg-white p-4 br-shadow">
                                <div className="privacy-policy-texts">
                                    <span className='text-muted fs-xsm' style={{fontSize:"18px"}}>Blinken 65 inch Ultra Series 4K HD Smart design utilizes the entire screen and has very little bezel, allowing you to concentrate on the information. A screen bezel is a border between a screen and the device frame or the space that surrounds a screen.</span>
                                </div>
