...
import fan1 from "../images/singlefan1.png";
import fan2 from "../images/singlefan2.png";
import fan3 from "../images/singlefan3.png";
                            ...
                            <div className="col-12 col-md-6 p-4">
                                <div className="main-product-details">
                                    <div className="pb-2 border-bottom">
                                        <h5>Urja Lite 350rpm Fusion Silver & Blue Ceiling Fan, Sweep: 1200 mm Urja Lite 350rpm Fusion Silve</h5>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className="bg-white p-4 br-shadow">
                                <div className="privacy-policy-texts">
                                    <span className='text-muted fs-xsm' style={{fontSize:"18px"}}>Introducing Urja Lite 350rpm Fusion Silver & Blue Ceiling Fan! This fan is perfect for anyone who wants a sleek and modern looking fan. It features a blue LED light that is sure to light up any room. It also has a powerful 350rpm motor that will quickly and easily move air around your room. And with a sweep of 1200mm, this fan will quickly and easily move air throughout your room.</span>
                                </div>
