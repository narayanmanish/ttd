...
import mix1 from "../images/mixer1 (1).png";
import mix2 from "../images/mixer2 (2).png";
import mix3 from "../images/mixer3.png";
                            ...
                            <div className="col-12 col-md-6 p-4">
                                <div className="main-product-details">
                                    <div className="pb-2 border-bottom">
                                        <h5>Bajaj GX 3701 750W Black Mixer Grinder with 3 Jars, 410528</h5>
                                    </div>
                                    <div className="py-3 border-bottom">
                                        <h5 className="price mb-3 d-flex align-items-center gap-3">
                                            <div className="red-price text-danger fw-bold ">₹3,278</div>
                                            <strike className="fs-xsm text-muted">₹4000</strike>
                                        </h5>
                        ...
                        <div className="col-12">
                            <div className="bg-white p-4 br-shadow">
                                <div className="privacy-policy-texts">
                                    <span className='text-muted fs-xsm' style={{fontSize:"18px"}}>The Bajaj GX 3701 750W Black Mixer Grinder with 3 Jars is a powerful and versatile kitchen appliance that can help you with a variety of tasks. With its 750 watt motor, it can easily grind tough ingredients like spices, nuts, and seeds. The Bajaj mixie is a mixer grinder that comes with 3 jars - a 1.5L liquidizing jar, a 300ml chutney jar and a 1L grinding jar. The mixer grinder has a power consumption </span>
                                </div>
