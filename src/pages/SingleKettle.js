...
import kettle1 from "../images/singlekettle1.png";
import kettle2 from "../images/singlekettle2.png";
import kettle3 from "../images/singlekettle3.png";
                            ...
                            <div className="col-12 col-md-6 p-4">
                                <div className="main-product-details">
                                    <div className="pb-2 border-bottom">
                                        <h5>Inalsa Upright 1.8L 1500W Black & Silver Electric Kettle </h5>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className="bg-white p-4 br-shadow">
                                <div className="privacy-policy-texts">
                                    <span className='text-muted fs-xsm' style={{fontSize:"18px"}}>Inalsa Upright 1.8L 1500W Black & Silver Electric Kettle is a premium quality product from Inalsa. Moglix is a well-known ecommerce platform for qualitative range of Electric Kettle. All Inalsa Upright 1.8L 1500W Black & Silver Electric Kettle are manufactured by using quality assured material and advanced techniques, which make them up to the standard in this highly challenging field. The materials utilized to manufacture Inalsa Upright 1.8L 1500W Black & Silver Electric Kettle, are sourced from the most reliable and official vendors, chosen after performing detailed market surveys.</span>
                                </div>
