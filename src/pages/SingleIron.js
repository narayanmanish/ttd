...
import iron1 from "../images/singleiron1.png";
import iron2 from "../images/singleiron2.png";
import iron3 from "../images/singleiron3.png";
                            ...
                            <div className="col-12 col-md-6 p-4">
                                <div className="main-product-details">
                                    <div className="pb-2 border-bottom">
                                        <h5>Longway Plancha 1000W Black Heavy Weight Dry Iron, DSQW-78688109</h5>
                                    </div>
                        ...
                        <div className="col-12">
                            <div className="bg-white p-4 br-shadow">
                                <div className="privacy-policy-texts">
                                    <span className='text-muted fs-xsm' style={{fontSize:"18px"}}>Classic EsseThe Longway Plancha 1000W Black Heavy Weight Dry Iron is best for those who want a durable and reliable iron. This iron has a heavy weight that makes it easy to press clothes, and the black color makes it easy to match with any d�cor. The Longway Plancha is an ISI certified dry iron that is made with stainless steel and ABS plastic. </span>
                                </div>
